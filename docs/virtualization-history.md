...
For a deeper treatment of how EPT/NPT works, including the page walk mechanics, TLB implications, and the relationship with IOMMU for device isolation, see the [Technology primer](technology-primer.md#extended-page-tables-eptnpt).
...
For a detailed look at how virtio devices use memory-mapped I/O, the virtqueue protocol, and advanced backends like vhost-user and DPDK, see [Memory mapped devices](memory-mapped-devices.md).
